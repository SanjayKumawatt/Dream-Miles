...
import img1 from "../assets/fourtosevendays/img1.jpg";
import img2 from "../assets/fourtosevendays/img2.webp";

import img4 from "../assets/fourtosevendays/img4.avif";

// --- MOCK PACKAGE DATA (4-7 Days Tours - All India) ---
const mediumDurationPackages = [
    {
        id: 201,
        title: '6 Days / 5 Nights Himachal Delight',
        slug: 'himachal-6d',
        duration: '6 Days',
        price: 22000, // INR
        rating: 4.9,
        url: img1, // Shimla/Manali
        cities: 'Shimla, Manali, Kullu',
        highlights: ['Solang Valley Snow Point', 'Hadimba Temple', 'Mall Road']
    },
    {
        id: 202,
        title: '7 Days / 6 Nights Kerala Backwaters & Beaches',
        slug: 'kerala-7d',
        duration: '7 Days',
        price: 30500, // INR
        rating: 4.8,
        url: img2, // Kerala Backwaters
        cities: 'Kochi, Munnar, Alleppey',
        highlights: ['Houseboat Stay', 'Tea Plantations', 'Spice Gardens']
    },
    {
        id: 203,
        title: '5 Days / 4 Nights Golden Triangle Basic',
        slug: 'golden-triangle-5d',
        duration: '5 Days',
        price: 18000, // INR
        rating: 4.7,
        url: 'https://images.unsplash.com/photo-1548013146-72479768bada?q=80&w=1951&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Taj Mahal
        cities: 'Delhi, Agra, Jaipur',
        highlights: ['Taj Mahal at Sunrise', 'Amer Fort', 'India Gate']
    },
    {
        id: 204,
        title: '4 Days / 3 Nights Goa Beach Escape',
        slug: 'goa-4d',
        duration: '4 Days',
        price: 14500, // INR
        rating: 4.5,
        url: img4, // Goa Beach
        cities: 'Goa (North & South)',
        highlights: ['Beach Huts', 'Water Sports', 'Nightlife']
    },
];

// --- Sub-Component: Tour Card ---
        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="bg-blue-700 py-8 border-b border-gray-200">
                <div className="container mx-auto px-4 text-white">
                    <h1 className="text-3xl font-bold">4 - 7 Days Regional & Classic Tours</h1>
                    <p className="text-lg font-light mt-1">Explore classic circuits and regional highlights across India.</p>
                    <div className="text-sm mt-2">
                        ...
                        <span className="ml-1 font-semibold">4-7 Days</span>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white p-6 rounded-lg shadow-md sticky top-24">
                            ...
                            <div className="mb-4 p-3 bg-red-50 rounded-lg">
                                ...
                                <p className="text-sm text-red-600 font-bold">4 to 7 Days</p>
                            </div>

                            {/* Filter Group: Location */}
                            <div className="mb-4">
                                <p className="font-semibold text-gray-700 mb-2">Popular Regions</p>
                                <label className="flex items-center text-sm text-gray-600 mb-1"><input type="checkbox" className="mr-2" /> North India</label>
                                <label className="flex items-center text-sm text-gray-600 mb-1"><input type="checkbox" className="mr-2" /> South India</label>
                                <label className="flex items-center text-sm text-gray-600 mb-1"><input type="checkbox" className="mr-2" /> West India</label>
                            </div>

                            {/* Filter Group: Price Range */}
                            <div className="mb-4">
                                <p className="font-semibold text-gray-700 mb-2">Price Range</p>
                                <input type="range" className="w-full" min="10000" max="40000" />
                                <p className="text-xs text-gray-500 text-center">₹ 10,000 - ₹ 40,000</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        {mediumDurationPackages.map((pkg) => (
...
export default FourToSevenDayTours;